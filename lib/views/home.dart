...
import 'package:playermus/views/player.dart';
      ...
      body: FutureBuilder<List<SongModel>>(
        ...
        builder:
          ...
          if (snapshot.data == null) {
            ...
            ); // Adjust this according to your UI.
          } else if (snapshot.data!.isEmpty) {
            // Return an error message or handle the error case.
            return Center(
              child: Text('No song found', style: ourStyle()),
            );
          } else {
            // Return your UI based on the fetched data in snapshot.data.
